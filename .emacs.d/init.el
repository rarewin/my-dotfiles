...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ox-asciidoc ox-gfm ox-rst ox-textile go-mode kotlin-mode ob-go ob-kotlin ob-swift swift-mode swift3-mode ob-ipython moe-theme counsel twittering-mode mhc smex yatex auto-complete ein wanderlust ddskk elscreen org)))
 '(show-paren-mode t))
(custom-set-faces
